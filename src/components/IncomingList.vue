        ...
        <form @submit.prevent="submitIncoming">
          <div class="row g-3">
            ...
            <div class="col-md-2">
              ...
              <input v-model="newIncoming.weight" type="number"  step="0.001" class="form-control" id="weight" />
            </div>
            <div class="col-md-2">
      ...
      <div class="card-body">
        ...
        <table class="table table-striped table-hover">
          ...
          <tr v-for="item in incomingList" :key="item.id">
            ...
            <td>
              <input v-model="item.weight" type="number"  step="0.001" class="form-control" />
            </td>
            <td>
